...
namespace core {
    ...
    class bootstrap {
        ...
        public function __construct($suppress_events = false)
        {
            ...
            //\core\Renderer\Template::render(['header'=>'<head><title>openDungeon</title></head>'], "core/_templates/page.tpl");
        ...
        /** TODO - Working 7/14/2015 - Needs further testing.
         * TODO move part of this into pre-init caching so that listener requests can be caches
         * function for preparing applications for attachments to listeners
        ...
        /** TODO - Working 7/14/2015 - Needs further testing.
         *
         * function for attaching prepared applications to listeners
         *
         */
        ...
        /** TODO Working ( 7/14/2015 ) but needs cleanup
                ...
                if ($f = $this->__includeFile($pathData, "include")) {
                    ...
                    foreach($f as $NS) {
                        ...
                        foreach($NS['classes'] as $class) {
	                         ...
	                         * so this prevent fake applications and bad calls
	                         *
         ...
         *
         * Disabled for now as it appears to be unneeded - Jan 30, 2015
        ...
        /*public  function __autoload($class_name) {
            //print $class_name;
            //require_once('applications/' . $class_name . '/' . $class_name . '.module ');
            //class_exists
        }*/
    ...
    class cachedModule
    {
       ...
       //  private $_Listento = "";
        ...
        /** @var array  */
        private $_LoadSettings = []; // class object of coreSettings;
